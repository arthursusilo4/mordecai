      ...
      <Box className="grid grid-cols-1 md:grid-cols-3 gap-6">
        <Card className="hover:shadow-lg transition-shadow">
          <CardContent className="text-center p-6">
            ...
            <Typography variant="body2" className="text-gray-600">
              Get a comprehensive overview of all users in your system with
        ...
        <Card className="hover:shadow-lg transition-shadow">
          <CardContent className="text-center p-6">
            ...
            <Typography variant="body2" className="text-gray-600">
              Efficiently manage user profiles with full CRUD operations and
        ...
        <Card className="hover:shadow-lg transition-shadow">
          <CardContent className="text-center p-6">
            ...
            <Typography variant="body2" className="text-gray-600">
              Simple and intuitive user registration form with validation and
              error handling.
            </Typography>
          </CardContent>
        </Card>
